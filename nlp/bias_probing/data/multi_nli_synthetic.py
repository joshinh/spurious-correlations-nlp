...
class MultiNLISyntheticConfig(datasets.BuilderConfig):
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(MultiNLISyntheticConfig, self).__init__(version=datasets.Version("1.0.0", ""), **kwargs)


class MultiNliSynthetic(datasets.GeneratorBasedBuilder):
    """MultiNLI: The Stanford Question Answering Dataset. Version 1.1."""

    BUILDER_CONFIGS = [
        MultiNLISyntheticConfig(
            name="plain_text",
    ...
    def _split_generators(self, dl_manager):
        ...
        train_path = os.path.join(mnli_path, "train_synthetic.txt")
