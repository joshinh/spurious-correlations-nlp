...
class MultiNLIBalancedConfig(datasets.BuilderConfig):
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(MultiNLIBalancedConfig, self).__init__(version=datasets.Version("1.0.0", ""), **kwargs)


class MultiNliBalanced(datasets.GeneratorBasedBuilder):
    """MultiNLIBalanced: The Stanford Question Answering Dataset. Version 1.1."""

    BUILDER_CONFIGS = [
        MultiNLIBalancedConfig(
            name="plain_text",
    ...
    def _split_generators(self, dl_manager):
        ...
        downloaded_dir = "/scratch/nhj4247/emnlp22_release/spurious-correlations-nlp/nlp/data"
        mnli_path = os.path.join(downloaded_dir, "multinli_1.0")
        train_path = os.path.join(mnli_path, "train_balanced_neg.txt")
        matched_validation_path = os.path.join(mnli_path, "dev_matched.txt")
        mismatched_validation_path = os.path.join(mnli_path, "dev_mismatched.txt")
