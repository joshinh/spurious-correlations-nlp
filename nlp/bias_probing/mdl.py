...
class OnlineCodeMDLProbe(MDLProbe):
    ...
    def evaluate(self, train_dataset: Dataset, test_dataset: Union[Dataset, Sized], dev_dataset: Dataset = None,
                 ...
                 reporting_root=None,
                 verbose=False, device=None, collate_fn=None, eval_groups=False):
        ...
        if eval_groups:
            nli_labels = np.array([ex[-1].item() for ex in test_dataset])
                        
            y_true_0_0 = y_true[(nli_labels == 0) & (y_true == 0)]
            y_true_0_1 = y_true[(nli_labels == 0) & (y_true == 1)]
            y_true_1_0 = y_true[(nli_labels == 1) & (y_true == 0)]
            y_true_1_1 = y_true[(nli_labels == 1) & (y_true == 1)]
            y_true_2_0 = y_true[(nli_labels == 2) & (y_true == 0)]
            y_true_2_1 = y_true[(nli_labels == 2) & (y_true == 1)]
            
            print(len(y_true_0_0), len(y_true_0_1), len(y_true_1_0), len(y_true_1_1), len(y_true_2_0), len(y_true_2_1))
            
            y_pred_0_0 = y_pred[(nli_labels == 0) & (y_true == 0)]
            y_pred_0_1 = y_pred[(nli_labels == 0) & (y_true == 1)]
            y_pred_1_0 = y_pred[(nli_labels == 1) & (y_true == 0)]
            y_pred_1_1 = y_pred[(nli_labels == 1) & (y_true == 1)]
            y_pred_2_0 = y_pred[(nli_labels == 2) & (y_true == 0)]
            y_pred_2_1 = y_pred[(nli_labels == 2) & (y_true == 1)]
            
            print(len(y_pred_0_0), len(y_pred_0_1), len(y_pred_1_0), len(y_pred_1_1), len(y_pred_2_0), len(y_pred_2_1))
            
            acc_0_0 = (y_true_0_0 == y_pred_0_0).sum()/len(y_pred_0_0)
            acc_0_1 = (y_true_0_1 == y_pred_0_1).sum()/len(y_pred_0_1)
            acc_1_0 = (y_true_1_0 == y_pred_1_0).sum()/len(y_pred_1_0)
            acc_1_1 = (y_true_1_1 == y_pred_1_1).sum()/len(y_pred_1_1)
            acc_2_0 = (y_true_2_0 == y_pred_2_0).sum()/len(y_pred_2_0)
            acc_2_1 = (y_true_2_1 == y_pred_2_1).sum()/len(y_pred_2_1)
            
            acc_min_0 = acc_0_0
            acc_maj_0 = (acc_1_0 * len(y_pred_1_0) + acc_2_0 * len(y_pred_2_0))/(len(y_pred_1_0) + len(y_pred_2_0))
            acc_min_1 = (acc_1_1 * len(y_pred_1_1) + acc_2_1 * len(y_pred_2_1))/(len(y_pred_1_1) + len(y_pred_2_1))
            acc_maj_1 = acc_0_1
            
            
            print("The group accuracies are: ", acc_min_0, acc_maj_0, acc_min_1, acc_maj_1)
