...
def train_probe(args: ProbeTrainingArgs, train_dataset: Dataset, model: nn.Module,
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=args.train_batch_size, collate_fn=collate_fn, shuffle=True)
    ...
    #probe_classifier, optimizer, epoch, checkpoint_loss = load_checkpoint(checkpoint_path, args.train_batch_size, args.num_train_epochs, probe_classifier, optimizer)
    
    epoch, checkpoint_loss = 0, 0.0
